...
export declare class SoloDefReactiveStorage<M> extends soloDef.SoloDefReactiveStorage<M> {
}
export declare class IncrNumReactiveStorage<M> extends incrNum.IncrNumReactiveStorage<M> {
}
